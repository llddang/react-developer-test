...
export const buttonVariants = cva(
  "inline-flex cursor-pointer items-center justify-center border border-transparent whitespace-nowrap rounded-md disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
